...
const statsData: StatDataItem[] = [
  ...
  { valueStr: "24/7", label: "Support Available", icon: <Clock className="w-8 h-8 text-primary" /> },
];
  ...
  return (
    <section id="home" className="relative min-h-screen flex flex-col items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32 flex flex-col items-center">
        ...
        <p
          className="mt-6 max-w-2xl mx-auto text-lg md:text-xl text-muted-foreground animate-fade-in-up"
        ...
        <div className="mt-10 animate-fade-in-up" style={{ animationDelay: "0.4s" }}>
          <Button
            size="lg"
            className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 text-lg rounded-lg shadow-lg transform hover:scale-105 transition-transform duration-300"
            asChild
          >
