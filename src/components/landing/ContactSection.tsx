        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
          <form className="space-y-6 p-8 bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl shadow-xl animate-fade-in-up">
            <div>
              ...
              <Input id="name" type="text" placeholder="Your Name" className="mt-1 bg-white/10 border-white/20 text-black placeholder:text-gray-700" />
            </div>
            <div>
              <Label htmlFor="email" className="text-black">Email Address</Label>
              <Input id="email" type="email" placeholder="your@email.com" className="mt-1 bg-white/10 border-white/20 text-black placeholder:text-gray-700" />
            </div>
            <div>
              <Label htmlFor="message" className="text-black">Message</Label>
              <Textarea id="message" placeholder="Your message..." rows={5} className="mt-1 bg-white/10 border-white/20 text-black placeholder:text-gray-700" />
            </div>
          ...
          <div className="space-y-6 p-8 bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl shadow-xl animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            ...
            <p className="text-gray-800">
              Email: <a href="mailto:info@magerconstruction.com" className="text-blue-600 hover:underline">info@magerconstruction.com</a>
            </p>
            <p className="text-gray-800">
