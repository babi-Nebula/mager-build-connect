      ...
      <div className='space-y-6'>
        <div>
          ...
          <p className='text-muted-foreground'>
            Manage your construction phases and track progress
          </p>
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
          {quickStats.map((stat) => (
            <Card
              key={stat.title}
              className='bg-slate-800/50 backdrop-blur-lg border border-border'>
          ...
          <Card className='bg-slate-800/50 backdrop-blur-lg border border-border'>
            ...
            <CardContent>
              <div className='space-y-3'>
                {[
                  {
                    update: "Foundation team completed sector 3",
                    time: "2 hours ago",
                  },
                  {
                    update: "New safety equipment delivered",
                    time: "4 hours ago",
                  },
                  {
                    update: "Weather delay reported for tomorrow",
                    time: "6 hours ago",
                  },
                ].map((update, index) => (
